  ...
  en: {
    translation: {
      contact: {
        ...
        recipientLabel: "SECURE ENDPOINT RECIPIENT",
        encryptionBadge: "ENC: RSA-4096",
        charUnit: "chars",
        submittingBtn: "Securing Tunnel Link...",
        transmittingTitle: "SECURE END-TO-END TRANSMISSION ACTIVE",
        protocolConsole: "Secure Handshake Node & Router Protocol Console",
        directInquiry: "Direct Inquiry",
        // 联系页的终端动画日志属于可见营销文案；保留技术标签作为品牌视觉的一部分，只翻译说明内容。
        logs: {
          client: "[CLIENT] Initializing secure telemetry channel...",
          routing: "[ROUTING] Binding payload descriptor nodes...",
          security: "[SECURITY] Applying TLSv1.3 encryption handshake with dutylix@163.com",
          encryption: "[ENCRYPTION] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[CORRIDOR] Injecting corporate client payload metadata regarding: [{{company}}]",
          validator: "[VALIDATOR] Processing client corporate email registry authentication...",
          committing: "[COMMITTING] Transmitting requirements packet of: [{{name}}]",
          gateway: "[GATEWAY] Remote SSL certificate handshake: VERIFIED",
          success: "[SUCCESS] Encryption tunnel routed successfully to corporate backlog.",
          sla: "[SLA] Assigned secure tracking token #DTL-{{token}}"
        },
  ...
  zh: {
    translation: {
      contact: {
        ...
        recipientLabel: "安全端点接收方",
        encryptionBadge: "加密: RSA-4096",
        charUnit: "字",
        submittingBtn: "正在建立安全连接...",
        transmittingTitle: "端到端安全传输进行中",
        protocolConsole: "安全握手节点与路由协议控制台",
        directInquiry: "直接咨询",
        logs: {
          client: "[客户端] 正在初始化安全遥测通道...",
          routing: "[路由] 正在绑定载荷描述节点...",
          security: "[安全] 正在与 dutylix@163.com 执行 TLSv1.3 加密握手",
          encryption: "[加密] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[通道] 正在注入企业客户载荷元数据: [{{company}}]",
          validator: "[校验] 正在处理企业邮箱注册认证...",
          committing: "[提交] 正在传输需求包: [{{name}}]",
          gateway: "[网关] 远程 SSL 证书握手: 已验证",
          success: "[成功] 加密通道已成功路由至企业需求队列。",
          sla: "[SLA] 已分配安全追踪令牌 #DTL-{{token}}"
        },
        successTitle: "加密提交成功！",
  ...
  zht: {
    translation: {
      contact: {
        ...
        recipientLabel: "安全端點接收方",
        encryptionBadge: "加密: RSA-4096",
        charUnit: "字",
        submittingBtn: "正在建立安全連接...",
        transmittingTitle: "端到端安全傳輸進行中",
        protocolConsole: "安全握手節點與路由協議控制台",
        directInquiry: "直接諮詢",
        logs: {
          client: "[客戶端] 正在初始化安全遙測通道...",
          routing: "[路由] 正在綁定載荷描述節點...",
          security: "[安全] 正在與 dutylix@163.com 執行 TLSv1.3 加密握手",
          encryption: "[加密] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[通道] 正在注入企業客戶載荷元數據: [{{company}}]",
          validator: "[校驗] 正在處理企業郵箱註冊認證...",
          committing: "[提交] 正在傳輸需求包: [{{name}}]",
          gateway: "[網關] 遠程 SSL 證書握手: 已驗證",
          success: "[成功] 加密通道已成功路由至企業需求隊列。",
          sla: "[SLA] 已分配安全追蹤令牌 #DTL-{{token}}"
        },
        successTitle: "加密提交成功！",
  ...
  th: {
    translation: {
      contact: {
        ...
        recipientLabel: "ผู้รับปลายทางที่ปลอดภัย",
        encryptionBadge: "ENC: RSA-4096",
        charUnit: "ตัวอักษร",
        submittingBtn: "กำลังสร้างลิงก์ที่ปลอดภัย...",
        transmittingTitle: "กำลังส่งข้อมูลแบบปลอดภัยต้นทางถึงปลายทาง",
        protocolConsole: "คอนโซลโหนดจับมือความปลอดภัยและโปรโตคอลเราเตอร์",
        directInquiry: "สอบถามโดยตรง",
        logs: {
          client: "[CLIENT] กำลังเริ่มช่องทาง telemetry ที่ปลอดภัย...",
          routing: "[ROUTING] กำลังผูกโหนด descriptor ของ payload...",
          security: "[SECURITY] กำลังทำ TLSv1.3 encrypted handshake กับ dutylix@163.com",
          encryption: "[ENCRYPTION] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[CORRIDOR] กำลังแนบ metadata payload ของลูกค้าองค์กร: [{{company}}]",
          validator: "[VALIDATOR] กำลังตรวจสอบ registry อีเมลองค์กร...",
          committing: "[COMMITTING] กำลังส่งแพ็กเกจข้อกำหนดของ: [{{name}}]",
          gateway: "[GATEWAY] การจับมือใบรับรอง SSL ระยะไกล: VERIFIED",
          success: "[SUCCESS] ส่งช่องทางเข้ารหัสไปยัง backlog องค์กรสำเร็จแล้ว",
          sla: "[SLA] กำหนดโทเคนติดตามความปลอดภัย #DTL-{{token}} แล้ว"
        },
  ...
  id: {
    translation: {
      contact: {
        ...
        recipientLabel: "PENERIMA ENDPOINT AMAN",
        encryptionBadge: "ENC: RSA-4096",
        charUnit: "karakter",
        submittingBtn: "Mengamankan tautan tunnel...",
        transmittingTitle: "TRANSMISI AMAN END-TO-END AKTIF",
        protocolConsole: "Konsol Node Handshake Aman & Protokol Router",
        directInquiry: "Pertanyaan Langsung",
        logs: {
          client: "[CLIENT] Menginisialisasi kanal telemetri aman...",
          routing: "[ROUTING] Mengikat node deskriptor payload...",
          security: "[SECURITY] Menerapkan handshake enkripsi TLSv1.3 dengan dutylix@163.com",
          encryption: "[ENCRYPTION] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[CORRIDOR] Menyisipkan metadata payload klien korporat terkait: [{{company}}]",
          validator: "[VALIDATOR] Memproses autentikasi registri email korporat...",
          committing: "[COMMITTING] Mengirim paket kebutuhan atas nama: [{{name}}]",
          gateway: "[GATEWAY] Handshake sertifikat SSL jarak jauh: VERIFIED",
          success: "[SUCCESS] Tunnel terenkripsi berhasil diarahkan ke backlog korporat.",
          sla: "[SLA] Token pelacakan aman ditetapkan #DTL-{{token}}"
        },
  ...
  ms: {
    translation: {
      contact: {
        ...
        recipientLabel: "PENERIMA ENDPOINT SELAMAT",
        encryptionBadge: "ENC: RSA-4096",
        charUnit: "aksara",
        submittingBtn: "Sedang mengamankan pautan tunnel...",
        transmittingTitle: "TRANSMISI SELAMAT HUJUNG-KE-HUJUNG AKTIF",
        protocolConsole: "Konsol Nod Handshake Selamat & Protokol Router",
        directInquiry: "Pertanyaan Terus",
        logs: {
          client: "[CLIENT] Memulakan saluran telemetri selamat...",
          routing: "[ROUTING] Mengikat nod deskriptor payload...",
          security: "[SECURITY] Melaksanakan handshake penyulitan TLSv1.3 dengan dutylix@163.com",
          encryption: "[ENCRYPTION] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[CORRIDOR] Menyuntik metadata payload pelanggan korporat berkenaan: [{{company}}]",
          validator: "[VALIDATOR] Memproses pengesahan registri e-mel korporat...",
          committing: "[COMMITTING] Menghantar paket keperluan daripada: [{{name}}]",
          gateway: "[GATEWAY] Handshake sijil SSL jauh: VERIFIED",
          success: "[SUCCESS] Tunnel tersulit berjaya dihalakan ke backlog korporat.",
          sla: "[SLA] Token penjejakan selamat ditetapkan #DTL-{{token}}"
        },
  ...
  es: {
    translation: {
      contact: {
        ...
        recipientLabel: "DESTINATARIO DEL ENDPOINT SEGURO",
        encryptionBadge: "ENC: RSA-4096",
        charUnit: "caracteres",
        submittingBtn: "Protegiendo enlace de túnel...",
        transmittingTitle: "TRANSMISIÓN SEGURA DE EXTREMO A EXTREMO ACTIVA",
        protocolConsole: "Consola de nodo de handshake seguro y protocolo de router",
        directInquiry: "Consulta directa",
        logs: {
          client: "[CLIENT] Inicializando canal de telemetría seguro...",
          routing: "[ROUTING] Vinculando nodos descriptores de payload...",
          security: "[SECURITY] Aplicando handshake cifrado TLSv1.3 con dutylix@163.com",
          encryption: "[ENCRYPTION] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[CORRIDOR] Inyectando metadata de payload corporativo sobre: [{{company}}]",
          validator: "[VALIDATOR] Procesando autenticación del registro de correo corporativo...",
          committing: "[COMMITTING] Transmitiendo paquete de requisitos de: [{{name}}]",
          gateway: "[GATEWAY] Handshake de certificado SSL remoto: VERIFIED",
          success: "[SUCCESS] El túnel cifrado se enrutó correctamente al backlog corporativo.",
          sla: "[SLA] Token de seguimiento seguro asignado #DTL-{{token}}"
        },
  ...
  pt: {
    translation: {
      contact: {
        ...
        recipientLabel: "DESTINATÁRIO DO ENDPOINT SEGURO",
        encryptionBadge: "ENC: RSA-4096",
        charUnit: "caracteres",
        submittingBtn: "Protegendo link de túnel...",
        transmittingTitle: "TRANSMISSÃO SEGURA DE PONTA A PONTA ATIVA",
        protocolConsole: "Console de nó de handshake seguro e protocolo de roteador",
        directInquiry: "Consulta direta",
        logs: {
          client: "[CLIENT] Inicializando canal de telemetria seguro...",
          routing: "[ROUTING] Vinculando nós descritores de payload...",
          security: "[SECURITY] Aplicando handshake criptografado TLSv1.3 com dutylix@163.com",
          encryption: "[ENCRYPTION] Cipher: ECDHE-RSA-AES256-GCM-SHA384",
          corridor: "[CORRIDOR] Injetando metadata de payload corporativo sobre: [{{company}}]",
          validator: "[VALIDATOR] Processando autenticação do registro de e-mail corporativo...",
          committing: "[COMMITTING] Transmitindo pacote de requisitos de: [{{name}}]",
          gateway: "[GATEWAY] Handshake de certificado SSL remoto: VERIFIED",
          success: "[SUCCESS] O túnel criptografado foi roteado com sucesso ao backlog corporativo.",
          sla: "[SLA] Token de rastreamento seguro atribuído #DTL-{{token}}"
        },
