...
const styles = StyleSheet.create({
  ...
  documentCard: {width: '100%', minHeight: 110, backgroundColor: colors.white, borderRadius: 16, paddingVertical: 22, paddingHorizontal: 18, marginBottom: 22, flexDirection: 'row', alignItems: 'center', alignSelf: 'stretch', shadowColor: '#0F172A', shadowOpacity: 0.065, shadowRadius: 16, shadowOffset: {width: 0, height: 6}, elevation: 4, borderWidth: 1, borderColor: '#EEF2F7'},
  documentCardPressed: {opacity: 0.92},
  documentIconWrap: {width: 50, height: 50, borderRadius: 16, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginRight: 18, flexShrink: 0},
  ...
  unreadDot: {width: 15, height: 15, borderRadius: 16, backgroundColor: '#FF2D55', shadowColor: '#FF2D55', shadowOpacity: 0.2, shadowRadius: 10, shadowOffset: {width: 0, height: 3}, elevation: 2},
  placeholderCard: {backgroundColor: colors.white, borderRadius: 16, padding: 18, alignItems: 'center', gap: 10},
