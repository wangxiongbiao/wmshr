...
const styles = StyleSheet.create({
  ...
  statusCard: {marginTop: 16, padding: 16, borderRadius: 16, backgroundColor: '#eff6ff'},
  contentCard: {marginTop: 16, marginBottom: 12, padding: 16, borderRadius: 16, backgroundColor: colors.white},
  contentText: {fontSize: 15, lineHeight: 24, color: colors.text},
  attachmentCard: {marginTop: 12, backgroundColor: colors.white, borderRadius: 16, padding: 18, flexDirection: 'row', alignItems: 'center', gap: 14, borderWidth: 1, borderColor: '#eef2ff'},
  ...
  inlinePreviewCard: {marginTop: 14, borderRadius: 16, backgroundColor: colors.white, borderWidth: 1, borderColor: '#e0ecff', overflow: 'hidden'},
  ...
  inlinePreviewClose: {width: 30, height: 30, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc'},
  ...
  readButton: {height: 52, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary, marginTop: 16, marginBottom: 32},
