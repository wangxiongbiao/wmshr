...
const styles = StyleSheet.create({
  ...
  input: {height: 58, borderWidth: 1, borderColor: colors.border, borderRadius: 20, paddingHorizontal: 16, fontSize: 16, color: colors.text, backgroundColor: '#f8fafc', letterSpacing: 0.5},
  ...
  errorCard: {marginTop: 18, flexDirection: 'row', alignItems: 'flex-start', gap: 10, padding: 16, borderRadius: 20, backgroundColor: '#fff7ed'},
