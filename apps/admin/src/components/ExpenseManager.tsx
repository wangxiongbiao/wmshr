...
interface ExpenseManagerProps {
  ...
  categories: string[];
  onUpdateExpenseModule: (snapshot: ExpenseModuleSnapshot) => void;
...
export function ExpenseManager({ employees, expenses, categories, onUpdateExpenseModule, addToast }: ExpenseManagerProps) {
  const saveExpenses = (newExpenses: ExpenseRecord[]) => {
    onUpdateExpenseModule({ expenses: newExpenses, categories });
  };
  ...
  const saveCategories = (newCats: string[]) => {
    onUpdateExpenseModule({ expenses, categories: newCats });
  };
