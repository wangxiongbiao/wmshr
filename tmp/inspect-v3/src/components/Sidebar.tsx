...
import { LayoutDashboard, Users, Clock, Wallet, FileText, Package, Receipt, Globe, Layers, ShoppingBag } from "lucide-react";
...
export function Sidebar({ activeTab, onTabChange }: SidebarProps) {
  const navItems = [
    ...
    { id: 'goods' as TabId, label: '入库管理', icon: Package },
    { id: 'expenses' as TabId, label: '费用核销', icon: Receipt },
    { id: 'customers' as TabId, label: '客户管理', icon: Globe },
    { id: 'products' as TabId, label: '商品管理', icon: Layers },
    { id: 'orders' as TabId, label: '订单管理', icon: ShoppingBag },
  ];
